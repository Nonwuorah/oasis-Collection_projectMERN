	...
	return (
		<div className='relative min-h-screen text-white overflow-hidden'>
			<div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
				...
				Step into Your Style Sanctuary, Discover curated fashion, timeless
          accessories, and everyday essentials that bring beauty and comfort to
          your world. Welcome to Oasis Collection, where elegance meets ease.
				</p>
